...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50  ">
            <div className="my-4">
                <button className="square bg-blue-400 p-2 text-2xl">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-400 justify-center">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-slate-200 rounded-lg shadow-md m-4 p-4 text-">
                            <div onClick={() => togglePopup(el)} className=" m-auto ">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-blue-600 text-white">
